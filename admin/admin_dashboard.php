...
<head>
	...
	<style>
        body {	
            background-image: url('../image/ryunosuke-kikuno-FKqxZ58bVjU-unsplash.jpg');
            background-size: cover; /* Optional: Adjust the image size to cover the entire background */
            background-repeat: no-repeat; /* Optional: Prevent image from repeating */
            /* Add other CSS styles for your dashboard here */
        }
    </style>
...
<body>
	...
	<div class="row pd-10" style="display: flex;
    overflow: scroll;
    width: 100%;
    padding: 10px;
    ">
		<div class="col-md-6" style="margin: 0px; margin-bottom: 10px">
	...
	<div class="row">
		<div class="col-md-10" style="margin: 0px; margin-bottom: 10px">
			<div class="card bg-light" >
